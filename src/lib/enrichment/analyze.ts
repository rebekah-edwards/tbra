...
- lgbtqia_representation: presence, not judgment. 1 = passing mention or minor side character; 2 = recurring side character or subplot; 3 = primary character or central relationship; 4 = identity themes are the book's focus. SUBTEXT DOES NOT COUNT — rate what the text states, not what it implies. An intense same-sex friendship, a close male duo, or a bond readers interpret romantically is 0 unless the book actually establishes the relationship or identity. The one exception is an explicit, unmistakable allegory (e.g. Automatic Noodle, whose story is openly a stand-in for trans experience). This is the single most common thing readers correct us on.
