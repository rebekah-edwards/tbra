...
export function ReadingGoalCard({ goal, year }: ReadingGoalCardProps) {
  ...
  return (
    <div
      className="rounded-xl border border-primary/20 bg-gradient-to-br from-surface to-surface-alt p-4 lg:px-6 cursor-pointer hover:border-primary/40 transition-colors"
