    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className={`flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center text-xs font-bold overflow-hidden ${
          ...
          {review.isAnonymous ? (
            <Image src="/logo.png" alt="tbr*a" width={36} height={36} className="w-full h-full object-cover" />
          ) : review.avatarUrl ? (
        ...
        <div className="flex-1 min-w-0">
          {review.isAnonymous ? (
            <p className="text-sm font-medium truncate text-muted italic">Anonymous</p>
          ) : review.username ? (
