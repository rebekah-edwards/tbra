...
export function CompletionDatePicker({
  ...
  return (
    ...
    >
      <div className="w-full max-w-sm rounded-t-2xl sm:rounded-2xl bg-surface border border-border shadow-2xl overflow-hidden">
        {/* Header */}
        ...
        <div className="px-5 pb-5 space-y-2.5">
          <button
            ...
            className="w-full rounded-xl bg-foreground text-background py-3 text-sm font-semibold hover:bg-foreground/90 transition-colors"
          >
            Continue
          </button>
          <button
